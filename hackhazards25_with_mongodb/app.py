...
def f_dashboard():
    ...
    faculty = faculty_collection.find_one({'email': session['email']})
...
@app.route('/f-usermanual.html')
def f_usermanual():
    return render_template("f-usermanual.html")
@app.route('/s-usermanual.html')
def s_usermanual():
    return render_template("s-usermanual.html")
